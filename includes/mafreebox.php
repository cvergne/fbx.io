...
require_once(APP_ROOT.'includes/lib_freebox/CURL.php');

require_once(APP_ROOT.'includes/lib_freebox/Conn.php');
require_once(APP_ROOT.'includes/lib_freebox/Dhcp.php');
require_once(APP_ROOT.'includes/lib_freebox/Download.php');
require_once(APP_ROOT.'includes/lib_freebox/Ftp.php');
require_once(APP_ROOT.'includes/lib_freebox/Fs.php');  # + FsUnix (extension)
require_once(APP_ROOT.'includes/lib_freebox/Fw.php');
require_once(APP_ROOT.'includes/lib_freebox/Phone.php');
require_once(APP_ROOT.'includes/lib_freebox/Storage.php');
require_once(APP_ROOT.'includes/lib_freebox/System.php');
require_once(APP_ROOT.'includes/lib_freebox/Wifi.php');

require_once(APP_ROOT.'includes/lib_freebox/Misc.php');  # regroupe Lan, Share, User, Ldc, IpV6, Igd
require_once(APP_ROOT.'includes/lib_freebox/Rrd.php');  # regroupe Lan, Share, User, Ldc, IpV6, Igd
